CREATE TABLE [dbo].[STATISTICS_EVENT04](
	[STATS_EVT04_ID] [numeric](38, 0) IDENTITY(1,1) NOT NULL,
 ...
 CONSTRAINT [PK_STATS_EVENT04] PRIMARY KEY CLUSTERED  ([STATS_EVT04_ID] ASC))
