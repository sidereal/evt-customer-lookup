CREATE TABLE [dbo].[STATISTICS_EVENT05](
	[STATS_EVT05_ID] [numeric](38, 0) IDENTITY(1,1) NOT NULL,
 ...
 CONSTRAINT [PK_STATS_EVENT05] PRIMARY KEY CLUSTERED  ([STATS_EVT05_ID] ASC))
